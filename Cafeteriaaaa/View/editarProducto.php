<?php
    ...
    $producto = $controladorProductos->buscarProducto($_GET['id_producto']);
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $producto['referencia'] ?>" required id="referencia" name="referencia" class="form-control" type="text" placeholder="referencia...">
                                        </div> 
                                    </div>
                                </div>
                                <div class="form-group">
                                            <label for="precio">precio:</label>
                                            <input value="<?php echo $producto['precio'] ?>" required id="precio" name="precio" class="form-control" type="text" placeholder="precio...">
                                        </div>
                                        <div class="form-group">
                                            <label for="peso">peso:</label>
                                            <input value="<?php echo $producto['peso'] ?>" required id="peso" name="peso" class="form-control" type="text" placeholder="peso...">
                                        </div>
                                </div>
                                <div class="form-group">
                                            <label for="categoria">categoria:</label>
                                            <input value="<?php echo $producto['categoria'] ?>" required id="categoria" name="categoria" class="form-control" type="text" placeholder="categoria...">
                                        </div>
                                         <div class="form-group">
                                            <label for="stock">stock:</label>
                                            <input value="<?php echo $producto['stock'] ?>" required id="stock" name="stock" class="form-control" type="text" placeholder="stock...">
                                        </div>
                                         <div class="form-group">
                                            <label for="fecha_creacion">fecha_creacion:</label>
                                            <input value="<?php echo $producto['fecha_creacion'] ?>" required id="fecha_creacion" name="fecha_creacion" class="form-control" type="text" placeholder="fecha_creacion...">
                                        </div>
                                <hr>
                                <div class="row">
                                    <div class="col-md-12">
